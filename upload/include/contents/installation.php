...
$scripter	    = 'FeTTsack';								// Name des Autors des Moduls
$script_name    = 'Newsletter Ex';								// Name des Moduls
$script_vers    = '1.1';												// Version des Moduls
$ilch_vers	    = '1.1o | 1.1p';												// Version des ilchClan Scripts
$ilch_update    = '';													// Update des ilchClan Scripts
...
?>
		...
		<tr class="Cmite">
		 <td align="center">
			...
			<strong>Entwickler:</strong> <?php echo $scripter; ?><br /><br />
			...
			Machen Sie zuerst ein <a href="admin.php?backup" target="_blank" style="font-style:italic; font-weight:bold;">Backup</a> Ihrer Datenbank und ihrer dateien!<br /><br />
			</div>
		 </td>
		</tr>
		<tr class="Cdark">
